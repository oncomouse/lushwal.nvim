...
local scheme = lush(function()
	...
	return {
		...
		ErrorMsg({ fg = colors.orange, bg = colors.background }),
		...
		SpellBad({ gui = "underline", fg = colors.orange, sp = colors.orange }),
		...
		DiffDelete({ fg = colors.orange, bg = colors.br_black, gui = "bold" }),
		DiffText({ fg = colors.blue, bg = colors.br_black }),
		DiffFile({ fg = colors.orange, bg = colors.background }),
